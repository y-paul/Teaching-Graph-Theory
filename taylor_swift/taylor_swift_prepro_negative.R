...
# ready for gephi
write.csv(nodes_df, str_c("taylor_swift/data/","neg_","nodes.csv"), row.names=F, fileEncoding="utf-8")
write.csv(edges_df, str_c("taylor_swift/data/", "neg_","edges.csv"), row.names=F, fileEncoding="utf-8")
